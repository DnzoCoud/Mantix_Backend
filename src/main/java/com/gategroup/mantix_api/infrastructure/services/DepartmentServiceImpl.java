...
import com.gategroup.mantix_api.infrastructure.persistence.DepartmentRepositoryJpa;
import com.gategroup.mantix_api.presentation.mappers.DepartmentMapper;
...
public class DepartmentServiceImpl implements IDepartmentService {
    ...
    public List<Department> findAll() {
        ...
        return entities.stream().map(DepartmentMapper::toDomain).collect(Collectors.toList());
    }
